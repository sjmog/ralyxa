...
RSpec.describe Alexa::OutputSpeech do
  describe 'building a speech component of a response' do
    it 'defaults to plain text and "Hello World"' do
      ...
      expect(Alexa::OutputSpeech.new).to eq expected_output_speech
    end
    ...
    it 'outputs a custom string if given' do
      ...
      expect(Alexa::OutputSpeech.new(speech: "Custom Text")).to eq expected_output_speech
    end
    ...
    it 'outputs SSML if given' do
      ...
      expect(Alexa::OutputSpeech.new(speech: "<speak>Hello World</speak>", ssml: true)).to eq expected_output_speech
    end
    ...
    it 'outputs default SSML if no string is given but SSML is required' do
      ...
      expect(Alexa::OutputSpeech.new(ssml: true)).to eq expected_output_speech
    end
    ...
    it 'limits the speech to 140 characters' do
      ...
      Alexa::OutputSpeech.new(speech: over_length_string)
    end
  end
end